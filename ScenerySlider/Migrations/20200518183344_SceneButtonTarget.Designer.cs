...
namespace ScenerySlider.Migrations
{
    ...
    [Migration("20200518183344_SceneButtonTarget")]
    partial class SceneButtonTarget
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScenerySlider.Models.SceneButton", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ScenerySlider.Models.SceneButton", b =>
                {
                    b.HasOne("ScenerySlider.Models.Scene", "OwnerScene")
                        .WithMany("EntryButton")
                        .HasForeignKey("OwnerSceneId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ScenerySlider.Models.Scene", "TargetScene")
                        .WithMany("SwitchSceneButton")
